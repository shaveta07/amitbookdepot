...
<div class="row">
    <div class="col-md-6">
        <div class="panel">
            <div class="panel-body text-center dash-widget dash-widget-left">
                <div class="dash-widget-vertical">
                    <div class="rorate" style="font-size:22px;">{{__('Attendance')}}</div>
                </div>
                <div class="col-xs-3">
                    <i class="fa fa-support fa-5x" style="font-size: 30px; margin-left: 20px;"></i>
                </div>
                <div class="col-xs-9 text-right">
                    <div class="huge" style="margin-bottom: 20px;font-weight: bold;">HR</div>
                <div></div>
                    <div style="margin-bottom: 20px;font-weight: bold;">Punch Attendance</div>
                </div>
                </br>
                </br>
                </br>
                <a href="{{route('attendance.PunchAttendance')}}">
                    <div class="panel-footer" style="margin-left: 130px;">

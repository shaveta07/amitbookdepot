...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title text-center">{{__('NICE SMS')}}</h3>
                </div>
                <div class="panel-body">
                    <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                        <input type="hidden" name="otp_method" value="ssl_wireless">
                        @csrf
                        <div class="form-group">
                            <input type="hidden" name="types[]" value="NICE_SMS_USER">
                            <div class="col-lg-3">
                                <label class="control-label">{{__('NICE SMS USER')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="NICE_SMS_USER" value="{{  env('NICE_SMS_USER') }}" placeholder="NICE SMS USER" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <input type="hidden" name="types[]" value="NICE_SMS_SID">
                            <div class="col-lg-3">
                                <label class="control-label">{{__('NICE SMS SID')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="NICE_SMS_SID" value="{{  env('NICE_SMS_SID') }}" placeholder="NICE SMS SID" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <input type="hidden" name="types[]" value="NICE_SMS_PASSWORD">
                            <div class="col-lg-3">
                                <label class="control-label">{{__('NICE SMS PASSWORD')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="NICE_SMS_PASSWORD" value="{{  env('NICE_SMS_PASSWORD') }}" placeholder="NICE SMS PASSWORD" >
                            </div>
                        </div>
                        <div class="form-group">
                            <input type="hidden" name="types[]" value="NICE_SMS_URL">
                            <div class="col-lg-3">
                                <label class="control-label">{{__('SSL SMS URL')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="NICE_SMS_URL" value="{{  env('NICE_SMS_URL') }}" placeholder="NICE SMS URL" >
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-lg-12 text-right">

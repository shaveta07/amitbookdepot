    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="panel">
                ...
                <div class="panel-body text-center">
                    <label class="switch">
                        <input type="checkbox" onchange="updateSettings(this, 'nicesms')" @if(App\OtpConfiguration::where('type', 'nicesms')->first() != null && \App\OtpConfiguration::where('type', 'nicesms')->first()->value == 1) checked @endif>
                        <span class="slider round"></span>
                    </label>
                </div>
            </div>

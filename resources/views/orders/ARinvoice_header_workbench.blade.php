...
<div class="col-lg-12">
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title">{{__('AR Invoice Header Workbench')}}</h3>
        </div>
        ...
        focus: function( event, ui ) {
            console.log(ui);
                 ...
                 $( "#mobile1"  ).val( "xxxxxxx" + ui.item.phone.substring(7) );
				  ...
				  $("#State").val(ui.item.state).trigger('change.select2');;
               ...
               return $( "<li>" )
               .append( "<a>" + "xxxxxxx" + item.phone.substring(5) + " - " + item.name + " + "  + item.email + "</a>" )
               .appendTo( ul );

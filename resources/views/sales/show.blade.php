    	...
    	<div class="panel-body">
    		...
    		<div class="invoice-bill row">
    			<div class="col-sm-6 text-xs-center">
    				<address>
        				<strong class="text-main"> @isset($order->shipping_address){{ json_decode($order->shipping_address)->name }}</strong><br>
    			...
    			<div class="col-sm-6 text-xs-center">
                    ...
                    <tr>
    					...
    					<td class="text-right">
							{{ single_price($order->orderDetails->sum('price') + $order->orderDetails->sum('tax') + $order->shippingprice + $order->codprice - $order->coupon_discount) }}
    					</td>
    				</tr>
                    <tr>
    					<td class="text-main text-bold">
    		...
    		<div class="clearfix">
				...
				<?php if($orderDetail->shipping_type != 'home_delivery'){ ?>
				<tr>
    				<td>
    					<strong>{{__('COD')}} :</strong>
    				</td>
    				<td>
    					{{ single_price($order->codprice) }}
    				</td>
    			</tr>
				<?php } ?>
                <tr>
    				...
    				<td>
						{{ single_price($order->shippingprice) }}
    				</td>
    			</tr>
				@if($order->coupan_discount != '0.00')
				<tr>
    				<td>
    					<strong>{{__('Coupan Discount')}} :</strong>
    				</td>
    				<td>

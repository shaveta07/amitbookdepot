        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <form action="{{ route('shipping_configuration.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="radio mar-btm">
                        <input id="order-shipping" class="magic-radio" type="radio" name="shipping_type" value="order_wise_shipping" <?php if(\App\BusinessSetting::where('type', 'shipping_type')->first()->value == 'order_wise_shipping') echo "checked";?>>
                        <label for="order-shipping">
                            <span>{{__('Order Wise Shipping Cost')}}</span>
                            <span></span>
                        </label>
                    </div>
                    <div class="radio mar-btm">

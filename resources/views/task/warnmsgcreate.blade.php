...
$store_id = Auth::user()->store_id;?>
        <!--Horizontal Form-->
        <!--===================================================-->
        <form class="form-horizontal" action="{{ route('Task.wrnmsgstore')}}" method="POST" enctype="multipart/form-data">
        	@csrf
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <textarea rows="4" cols="20" name="warnmsg" class="editor" data-buttons='bold,underline,italic,hr,|,ul,ol,|,align,paragraph,|,image,table'></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <input type="date" required    name="publishdate" id="publishdate" class="form-control"> 
                    </div>
                </div>

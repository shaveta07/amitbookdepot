    ...
    @if(session()->get('msg') != null)
        ...
        <div class="panel-body">
            ...
            <table class="table table-responsive" >
                ...
                <td>Supplier ID:</td><td><?php echo $invoice_header_data->supplier_id; ?></td></tr>
			...
			<tr><td>Booked Quantity</td><td><?php echo $invoice_header_data->quantity ?></td><td>&nbsp;</td><td>&nbsp;</td></tr>
            </table>
            <br />
			<table class="table table-responsive" >
  ...
  <div class="modal-dialog" style="width:70%">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         ...
         <form method="post" action="{{ route('APInvoiceAlls.ProductUpdateold') }}" enctype="multipart/form-data"><div class="error"><?php echo $msg; ?></div>
         @csrf
          <div class="form-group">
		   ...
		   <div class="form-group">
			...
			<input type="text" value="<?php echo $invoice_header_data->igst; ?>" name="igst" required  id="igst" class="form-control" />
			</div>
			
			<div class="row">
			<div class="form-group col-sm-6 col-lg-6 col-xs-6">
			<label for="igst">SGST*: </label>
			<input type="text" value="<?php echo $invoice_header_data->sgst; ?>" name="sgst"  required id="sgst" class="form-control" />
			</div>
			<div class="form-group col-sm-6 col-lg-6 col-xs-6">
			<label for="cgst">CGST(*) </label>
			<input type="text" value="<?php echo $invoice_header_data->cgst; ?>" name="cgst"  required id="cgst" class="form-control" />
			<!-- <input type="hidden" value="" name="aptype"   id="aptype" class="form-control" />
			<input type="hidden" value="" name="aptype"   id="aptype" class="form-control" /> -->
			</div>
			</div>
			<div class="form-group">

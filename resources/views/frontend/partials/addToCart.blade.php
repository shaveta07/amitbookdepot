    ...
    <div class="row no-gutters cols-xs-space cols-sm-space cols-md-space">
        ...
        <div class="col-lg-6">
            ...
            <div class="product-description-wrapper">
                ...
                <hr>
                <?php 
                            echo "<table id='bulk_prod_info' class='table variation_table'><thead><tr><td>Select</td><td>Quantity</td><td>Price</td><td>Variant</td></tr></thead><tbody>"; 
                            echo "</tbody></table>";
                            ...
                            <div class="col-10">
                                <div class="product-quantity d-flex align-items-center">
                                    <div class="input-group input-group--style-2 pr-3" style="width: 160px;">
                                        ...
                                        <input type="text" name="quantity" class="cartqty form-control input-number text-center"

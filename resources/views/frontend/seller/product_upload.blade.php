                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="name" id="product_name" placeholder="{{__('Product Name')}}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Author')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="mb-3">
                                            <select class="form-control mb-3 demo-select2-placeholder" name="author_id" id="author" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Tags')}}<span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="tags[]" placeholder="Type to add a tag" required data-role="tagsinput">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('ISBN')}}<span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="isbn" id="isbn"  placeholder="ISBN" required >
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Version')}}<span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('OLD ISBN')}}<span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="oldisbn" id="oldisbn"  placeholder="ISBN" required >
                                        </div>
                                    </div>
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" min="0" value="0" step="0.01" class="form-control mb-3" placeholder="{{__('MRP')}}" id="mrp" name="mrp" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-2">
                                            <label>{{__('ERP Price')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-4">
                                            <input type="number" min="0" step="0.01" placeholder="{{__('ERP Price')}}" class="form-control" name="erpprice" id="erpprice" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Minimum Stock QTY')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-4">
                                            <input type="number" min="-1" step="1" placeholder="{{__('Minimum Stock QTY')}}" name="minstock" id="minstock" class="form-control" required>

                                        </div>
                                        <div class="col-md-2">
                                            <label>{{__('Maximum Stock QTY')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-4">
                                            <input type="number" min="0" step="0.01" placeholder="{{__('Maximum Stock QTY')}}" name="maxstock" id="maxstock" class="form-control" required>

                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Maximum Order Quantity')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="number" min="0" step="0.01" placeholder="{{__('Maximum  Order Quantity')}}" id="maxorderqty" name="maxorderqty" class="form-control" required>

                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Minimum Order QTY')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-4">
                                            <input type="number" min="0" step="1" placeholder="{{__('Minimum Order QTY')}}" id="minorderqty" name="minorderqty" class="form-control" required>

                                        </div>
                                        <div class="col-md-2">
                                            <label>{{__('On Rent')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="row rentoption" style="display:none" id="rentoption">
                                        <div class="col-md-2">
                                            <label>{{__('Security Amount')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-4">
                                            <input type="number" min="0" step="0.01" placeholder="{{__('Security Amount')}}" name="securityamount" id="securityamount"  class="form-control" required>

                                        </div>
                                        <div class="col-md-2">
                                            <label>{{__('Rent Amount')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-4">
                                            <input type="number" min="0" step="1" placeholder="{{__('rentamount')}}" name="rentamount" id="rentamount" class="form-control" >

                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('SGST')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-4">
    ...
    $(document).ready(function(){
      ...
      $( "#product_name" ).autocomplete({
        ...
        select: function (event, ui) {
            ...
            // alert(ui.item.brand_id);
            $("#brands").val(ui.item.brand_id);
            $("#brands").trigger('change');
            $("#author").val(ui.item.author_id);
            $("#author").trigger('change');
            var _cat_name = "";
            if(ui.item.category_name != null)
            {
                _cat_name += ui.item.category_name;
            }
            if(ui.item.sub_category_name != null)
            {
                _cat_name += ">" + ui.item.sub_category_name;
            }
            if(ui.item.sub_sub_category_name != null)
            {
                _cat_name += ">" + ui.item.sub_sub_category_name;
            }

            $('#product_category').text(_cat_name);
            $("#category_id").val(ui.item.category_id);
            $("#subcategory_id").val(ui.item.subcategory_id);
            $("#subsubcategory_id").val(ui.item.subsubcategory_id);
            //$("#product_category").trigger('change');

...
class OTPVerificationController extends Controller
{
     ...
     * @return void
     */
    public function send_supplier_code($user){
        
            sendSMS($user->mobile1, env('APP_NAME'), 'Please Varify your OTP and OTP is : '.$user->otp, 'Your invoice Amount will INR :'.$user->total);

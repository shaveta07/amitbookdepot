...
Route::post('/users/otplogin', 'HomeController@otplogin')->name('user.otplogin');
Route::post('/users/otpverify', 'HomeController@otpverify')->name('user.otpverify');
Route::post('/users/resend_code', 'HomeController@resend_code')->name('user.resend_code');
...
Route::post('/product/selected_variation_row', 'HomeController@selected_variation_row')->name('products.selected_variation_row');
...
Route::post('/cart/cart_register', 'CartController@cart_register')->name('cart.cart_register');
...
Route::group(['middleware' => ['checkout']], function(){
	...
	Route::post('/checkout/guest_register', 'CheckoutController@guest_register')->name('checkout.guest_register');
	Route::post('/checkout/check_postal_code', 'CheckoutController@check_postal_code')->name('checkout.check_postal_code');
	Route::post('/checkout/getdistrict', 'CheckoutController@getdistrict')->name('checkout.getdistrict');
	Route::post('/checkout/update_shipping_cost', 'CheckoutController@updateshippingcost')->name('checkout.update_shipping_cost');
	Route::post('/checkout/checkManual', 'CheckoutController@checkManual')->name('checkout.checkManual');
	Route::post('/checkout/checkforpayment', 'CheckoutController@checkforpayment')->name('checkout.checkforpayment');
	Route::post('/checkout/updateShipping', 'CheckoutController@updateShipping')->name('checkout.updateShipping');
});
...
Route::get('/products/getProductSeller/{id}','ProductController@getProductSeller')->name('products.getProductSeller');

Route::group(['middleware' => ['auth']], function(){
	Route::post('/products/store/','ProductController@store')->name('products.store');
	Route::post('/products/getProduct/','ProductController@getProduct')->name('products.getProduct');

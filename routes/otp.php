...
// Route::post('/verification/otp', 'OTPVerificationController@verification')->name('verification.otp');
Route::post('/verification/phone', 'OTPVerificationController@verify_phone')->name('verification.submit');
Route::post('/verification/phone_user', 'OTPVerificationController@verify_phone_user')->name('verification.phone_user');
Route::post('/verification/submit_guest', 'OTPVerificationController@verify_phone_guest')->name('verification.submit_guest');
...
Route::post('/verification/phone/code/guest_resend', 'OTPVerificationController@guest_resend_verificcation_code')->name('guest.verification.phone.resend');
